            ...
            content: (
                <>
                    <p className="font-medium">
                        We are pleased to assist you with every detail of your gifting experience.
                    </p>
                    <ul className="list-disc pl-6 text-justify space-y-2">
                        <li>
                            Signature Louis Vuitton Packaging: Your order will be carefully delivered in the iconic
                            Louis Vuitton gift box. A shopping bag may be offered at checkout, depending on the product
                            purchased.
                        </li>
                        <li>
                            Returns & Exchanges: Almost every gift is eligible for return or exchange in accordance with
                            our Return & Exchange Policy here. The original gift receipt, as well as the original
                            packaging, will be required.
                        </li>
                        <li>
                            Gift Receipts: The gift receipts will not include the price of the item. The complete
                            invoice that includes the price is sent to the gifter by email once the parcel is shipped
                            and will be available on the purchaser's MyLV account.
                        </li>
                        <li>
                            If you wish to send your gift order directly to the gift recipient, you can enter the
                            recipient's address in the "Delivery Address" section on the checkout page. A signature is
                            required upon delivery. If the recipient's phone number is added at checkout, they may be
                            notified with the delivery information.
                        </li>
                    </ul>
                </>
            ),
